<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\baobiao\public/../application/index\view\index\index.html";i:1503583385;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>【<?php echo $username; ?>】业绩上报 <a href="<?php echo url('index/add'); ?>" class="layui-btn layui-btn-small">上报业绩</a> <a href="<?php echo url('index/goout'); ?>" class="layui-btn layui-btn-danger layui-btn-small">退出</a></legend>
</fieldset>
...
<table class="layui-table">
    ...
    <?php if(is_array($yeji) || $yeji instanceof \think\Collection || $yeji instanceof \think\Paginator): $i = 0; $__LIST__ = $yeji;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td><?php if($vo['state'] == 0): ?><a href="<?php echo url('index/edit',array('id'=>$vo['Id'])); ?>" class="layui-btn layui-btn-danger layui-btn-mini">编辑</a><?php else: ?><span class="layui-btn layui-btn-danger layui-btn-mini">不可修改</span><?php endif; ?></td>
        </tr>
