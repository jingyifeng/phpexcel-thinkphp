<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\baobiao\public/../application/admin\view\report\yuebao.html";i:1503498919;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" id="myform" method="post" action="<?php echo url('report/yuebao'); ?>">
