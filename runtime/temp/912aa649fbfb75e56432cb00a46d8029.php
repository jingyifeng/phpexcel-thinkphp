<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\baobiao\public/../application/admin\view\index\welcome.html";i:1502274468;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-colla-item">
        ...
        <div class="layui-colla-content layui-show">
            <table class="layui-table">
                ...
                <tr>
                    <td>QQ群</td>
                    <td>494826865（易风课堂PHP交流群）</td>
                </tr>
                <tr>
                    <td>官网</td>
                    <td><a href="javascript:parent.location.href='http://bbs.daxue518.com/';">bbs.daxue518.com</a></td>
                </tr>
            </table>
        </div>
    </div>
